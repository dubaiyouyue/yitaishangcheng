		...
		$(this).each(function(){
			$(this).hover(function(e){
				if(/.png$|.gif$|.jpg$|.bmp$|.jpeg$/.test($(this).attr("data-bimg"))){
					$("body").append("<div id='preview'><img src='"+$(this).attr('data-bimg')+"' style='width:400px;height:562px;'/></div>");//style 后面加上的。就客户要求缩略图固定宽高。add by wzw 20130323
				}
