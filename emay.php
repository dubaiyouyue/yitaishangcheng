<?php
session_start();
$ssccddoo=rand(100000,999999);
$_SESSION['ssccddoo']=$ssccddoo;
$_GET['tel']=$_GET['tel']+0;
$_SESSION['mobile']=$_GET['tel'];
/**
 * 在PHP 5.5.17 中测试通过。
...
//通用接口发送样例
    $apikey = "0a2ec79806173ea8bc80506761b2d24f"; //请用自己的apikey代替
    $mobile = $_GET['tel']; //请用自己的手机号代替
    $text="【中国意态】您的验证码是".$ssccddoo;
