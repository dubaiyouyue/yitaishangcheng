...
$(document).ready(function(){
    ...
    $(".slide#first").backstretch("/GZphp/Tpl/Home/Default/web/images/bg1.jpg");
    $(".slide#sec").backstretch("/GZphp/Tpl/Home/Default/web/images/bg2.jpg");
    $(".slide#thirth").backstretch("/GZphp/Tpl/Home/Default/web/images/bg4.jpg");
    $(".slide#fourth").backstretch("/GZphp/Tpl/Home/Default/web/images/bg5.jpg");
