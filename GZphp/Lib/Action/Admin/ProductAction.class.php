...
class ContentAction extends AdminbaseAction
{
    ...
    public function insert($module='',$fields=array(),$userid=0,$username='',$groupid=0,$new_rrrr='')
    {
		...
		foreach($_POST['yansess'] as $k=>$v){
			if($k && $_POST['yansess'][$k] && $_POST['chicun'][$k] && $_POST['jiage'][$k] && $_POST['kucun'][$k]) $newwwss.='moweilin'.$_POST['yansess'][$k].'lizhenqiu'.$_POST['chicun'][$k].'lizhenqiu'.$_POST['jiage'][$k].'lizhenqiu'.$_POST['kucun'][$k];
			elseif($_POST['yansess'][$k] && $_POST['chicun'][$k] && $_POST['jiage'][$k] && $_POST['kucun'][$k]) $newwwss.=$_POST['yansess'][$k].'lizhenqiu'.$_POST['chicun'][$k].'lizhenqiu'.$_POST['jiage'][$k].'lizhenqiu'.$_POST['kucun'][$k];
		}
		$_POST['kkcc']=$newwwss;
		//echo $newwwss;
		//dump($_POST);
