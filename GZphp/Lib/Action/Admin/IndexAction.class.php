...
class IndexAction extends AdminbaseAction
{
	...
	//更新缓存后不自己生成 首页静态html,需执行生成代码 add by wzw 2014-04-25
	/*public function _after_cache() {
		if($this->sysConfig['HOME_ISHTML']){	
		file_put_contents('index.html',file_get_contents('http://www.gxhansen.com/index.php?m=Index&a=index'));		
		}
	}*/
	...
	public function main() {
		...
		$info = array(
            ...
            'app_debug'=>APP_DEBUG ? '<font color="red">True</font>' : 'False',
            );
		$gzphp_info=array(
			'gzphp_VERSION'=> VERSION.' '.UPDATETIME.' [ <a href="http://www.resonance.com.cn" target="_blank">'.L('view_new_VERSION').'</a> ]',			
			'license'=> '<b id="GZphp_license"></b>',
			'SN'=> '<b id="GZphp_sn"></b>',
			'update'=>  ' <b id="GZphp_update"></b>',
			
		);
		$this->assign('gzphp_info',$gzphp_info);
